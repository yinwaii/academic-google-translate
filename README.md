...
2. 在翻译arxiv和ieeexplore网页版论文时，避免排版混乱，避免翻译作者、图表、引用、参考文献等。

## 论文一键翻译优化
在翻译arxiv和ieeexplore网页版论文时，本插件可以避免排版混乱，避免翻译作者、图表、引用、参考文献等。
...
### 如何使用ieeexplore浏览网页版论文
1. 使用ieeexplore访问所需论文，如 https://ieeexplore.ieee.org/document/9355319
2. 使用谷歌翻译插件翻译该网页

#### 优化效果
优化前：<img src="https://github.com/yinwaii/academic-google-translate/blob/main/imgs/ieeexplore-raw.png?raw=true" alt="无优化" width="40%" />
优化后：<img src="https://github.com/yinwaii/academic-google-translate/blob/main/imgs/ieeexplore-new.png?raw=true" alt="优化后" width="40%" />
...
## 更新日志
- 2024-06-02: 发布v1.1版本，支持对ieeexplore网页版论文的翻译优化
